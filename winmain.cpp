                     ...
                     int       nCmdShow)
{
	...
	hAccelTable = LoadAccelerators(hInstance, (LPCTSTR)IDC_PHYSICS);

	// Main message loop for game application
    while( 1 )
    {
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, (LPCTSTR)IDI_PHYSICS);
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+0);
	wcex.lpszMenuName	= (LPCSTR)IDC_PHYSICS;
